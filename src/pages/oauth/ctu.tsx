...
import {
  RegisterCtuFelMutation,
  RegisterCtuFitMutation,
  RegisterCtuPayload,
} from '../../data/RegisterCtu';
...
class Ctu extends Component<WithApolloClient<WithRouterProps>, CtuState> {
  ...
  componentDidUpdate(
    prevProps: Readonly<WithApolloClient<WithRouterProps>>,
    prevState: Readonly<CtuState>,
    snapshot?: any
  ) {
      ...
      client
        ...
        .then((d) => {
          ...
          Sentry.captureException({
            errors: d.errors,
            userErrors: getUserErrors(d.data),
          });
          return null;
        })
        .catch((e) => {
